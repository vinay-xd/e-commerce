  ...
  return (
    <>
      <div className='Login-container w-[1305px] h-[781px] flex justify-between mt-[200px] '>
        ...
        <div className='LoginDetails w-[371px] mt-[150px] leading-6'>
          <div className='mb-12'>
          ...
          <div className=' mb-10'>
            <input className='block border-b-2 pb-2 mb-[20px] w-[100%]' type="text" name="username" placeholder='Email or Phone Number' />

            <input className='block border-b-2 pb-2 mb-[20px] w-[100%]' type="text" name="password" placeholder='Password' />
          </div>
