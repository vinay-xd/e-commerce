...
function BestSCard({imgurl, title, price, rating, review, crossprice, link, shopinglist}) {
    ...
    <div className='group w-[270px] '>
      <div className='ImgCon relative mb-4 w-[270px] h-[250px] overflow-hidden' style={{backgroundColor: '#f5f5f5'}}>
        <img className=' absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]' src={imgurl} alt="" />
          ...
          <button className='absolute -bottom-10 bg-[#000] group-hover:bottom-0 transition-all duration-[450ms] ease-in-out text-[#fff] rounded w-[270px] text-center font-[500] p-2' onClick={shopinglist}>Add To Cart</button>
      </div>
